...
public class StarServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // prepare query
            String query2 = "SELECT * from stars_in_movies left join movies on movieId = id WHERE starId = '"+id+"'";
            // execute query
            ...
            while (movieSet.next()){
                ...
                out.println("<p><a href=\"http://localhost:8080/cs122b_project1_star_example_war/Movie?id=" + movieid + "\">" + moviename + "</a></p>");
            }
